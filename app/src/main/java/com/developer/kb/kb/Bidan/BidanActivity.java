package com.developer.kb.kb.Bidan;
...
public class BidanActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
...
//                Toast.makeText(getApplicationContext(), msg, Toast.LENGTH_SHORT).show();
    ...
    private void postAddKader() {
        ...
        Call<ResponseUsersKaderGet> callPasien = apiServicePasien.addBidan(namaKader,nip,uName,pass,alamatKader,noTelpKader);
        callPasien.enqueue(new Callback<ResponseUsersKaderGet>() {
            ...
            public void onResponse(Call<ResponseUsersKaderGet> call, Response<ResponseUsersKaderGet> response) {
                ...
                finish();
                Toast.makeText(BidanActivity.this, msg, Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailure(Call<ResponseUsersKaderGet> call, Throwable t) {
                Toast.makeText(BidanActivity.this, "failed add bidan", Toast.LENGTH_SHORT).show();
